...
abstract class AppLocalizations {
  ...
  ///
  /// In en, this message translates to:
  /// **'Sign in to take control of the ambience.'**
  ...
  /// No description provided for @installerLoginTitle.
  ///
  /// In en, this message translates to:
  /// **'Installer configuration'**
  String get installerLoginTitle;

  /// No description provided for @installerLoginDescription.
  ///
  /// In en, this message translates to:
  /// **'Sign in with an administrator account to edit the house, devices, and KNX.'**
  String get installerLoginDescription;

  /// No description provided for @installerLoginAdminOnlyError.
  ///
  /// In en, this message translates to:
